...
<head>
    ...
    <title>CHT Travel - Accommodations</title>
...
<body class="cv-body">
    ...
    <main class="cv-content">
        ...
        <div class="cv-main">
            ...
            <div class="cv-section-header" style="display:flex; justify-content:space-between; align-items:flex-end;">
                <div>
                    <h1 class="cv-page-title">Accommodations</h1>
                    <p class="cv-page-subtitle">Browse available hotels and accommodations</p>
                </div>
            ...
            <div class="cv-card">
                <div class="cv-card-header">
                    <div>
                        ...
                        <p id="hotelsCountLabel">0 accommodations</p>
                    </div>
                    <div class="cv-search-box" style="width:300px;">
                        <svg viewBox="0 0 24 24"><path d="M15.5 14h-.79l-.28-.27A6.47 6.47 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/></svg>
                        <input type="text" id="hotelsSearch" placeholder="Search by name or address...">
                    </div>
                </div>
                <div class="cv-table-wrapper">
                    <table class="cv-table" id="hotelsTable">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Hotel Name</th>
    ...
    <!-- Page Script -->
    <script src="assets/js/user/hotels.js"></script>
</body>
</html>
