...
<head>
  ...
  <meta charset="UTF-8">
  <title>CHT Travel & Tour Management - New Booking (Step 2)</title>
...
<body class="cv-body">
  ...
  <main class="cv-content">
            ...
            <div class="cv-wizard-grid">
                ...
                <div class="cv-wizard-form-area">
                    <div class="cv-section-header">
                        <h1 class="cv-page-title">Select Tour Package</h1>
                        <p class="cv-page-subtitle">Choose a package that best fits your customer’s preferences.</p>
                    </div>

                    <div class="cv-tours-grid" id="packageGrid">
                        <!-- Cards rendered by JS -->
                        <div style="text-align:center; padding:40px; color:var(--text-muted);">Loading packages...</div>
                    </div>
                </div>
                ...
                <aside class="cv-wizard-summary">
                    <div class="cv-summary-header">
                        ...
                        <div class="cv-summary-progress">
                            ...
                            <span id="summaryPercent">33% Complete</span>
                        </div>
                    </div>
    ...
    <footer class="cv-wizard-footer">
        ...
        <div class="cv-wizard-progress-bar">
            <span class="cv-progress-text">Step 2 of 6</span>
            <div class="cv-progress-track">
                <div class="cv-progress-fill" style="width: 33%;"></div>
            </div>
        </div>
  ...
  <script src="assets/js/bookings/bookings2.js"></script>
</body>
</html>
