    ...
    await queryInterface.bulkInsert('employee', [
      {
        ...
        name: 'admin',
        email: 'admin@cht.com',
        password: '$2y$10$eveTnsh7rw/smuXCfep4oOe9ga78uBQ6UW0uXYa44VgEPRg8oOq6W',
      ...
      },
      {
        ...
        password: '$2y$10$2SxJEzuUwbV2TgFyBK2Bp.kPwQ4rBMyncIelXR.6S7DFIuZESVWHG',
        contactNumber: '09170000001',
        isManager: 1,
        isActive: 1
      },
      {
        ...
        password: '$2y$10$jQKOurbxf6Zje1KCzE3AfuDOYLJkbP3HV5VsC1Px8P5OdMh2YhIF2',
      ...
      },
      {
        ...
        password: '$2b$10$XhO0OUElqVmTxxnt3B/qLu4DOxMZFfv5HspXDtJJJLQY65Hbut2tC',
